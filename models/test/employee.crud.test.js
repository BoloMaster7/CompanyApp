...
//       const EmployeeTest = await Employee.findOne({ firstName: 'firstName One' });
//       await EmployeeTest.remove();
//       const removedEmployee = await Employee.findOne({ firstName: 'firstName One' });
